...
async function loadPokemon(id) {
  try {
    ...
    if (currentPokemonId === id) {
      ...
      const flavorText = getSpanishFlavorText(pokemonSpecies);
    ...
    console.error("Parece que el Pokemon se está escondiendo:", error);
    return false;
  }
}
...
function getSpanishFlavorText(pokemonSpecies) {
